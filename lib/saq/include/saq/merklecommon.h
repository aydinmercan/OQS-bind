...
/// \brief Hashing callback function used by a Merkle Nodes, Authenticating
/// Paths, and Merkle Streams.
///
...
///             hash_len will be updated with how large the hash would have
///             been.
///
...
/// \return SAQ_SUCCESS if the list is initalized successfully; SAQ_FAILURE
/// otherwise.
SAQ_STATUS
...
/// \brief Destroys the given SAQ_list_t l and optionally frees the data it
/// points to.
///
