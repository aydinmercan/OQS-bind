...
/// \param[in] data The data to be hashed. If Data is not NULL, left and right
/// must be NULL.
...
/// \param[in,out] hash_len Contains the length of the hash byte region.
/// *hash_len contains the hash length on return.
///
...
///
/// \return SAQ_SUCCESS if the left child was succesfully fetched; SAQ_FAILURE
/// otherwise.
SAQ_STATUS
...
///
/// \return SAQ_SUCCESS if the right child was succesfully fetched; SAQ_FAILURE
/// otherwise.
SAQ_STATUS
...
///
/// \return SAQ_SUCCESS if the parent was succesfully set; SAQ_FAILURE
/// otherwise.
SAQ_STATUS
...
///
/// \return SAQ_SUCCESS if the parent was succesfully fetched; SAQ_FAILURE
/// otherwise.
SAQ_STATUS
...
/// \brief Serializes a given SAQ_merkle_node_t and stores bytes in given byte
/// region.
///
